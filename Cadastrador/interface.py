...
def cadastro():
    ...
    save = Button(CFrame, text = 'Salvar', width = 30, command=salvar)
    save.place(x=100, y=330)

    Retornar = Button(CFrame, text = 'Retornar', width = 30, command=lambda:back(CFrame))
    Retornar.place(x=100, y=370)


Cadastro_btn = ttk.Button(RFrame, text = 'Cadastrar Informação', width = 40, command=cadastro)
...
def editar():
    ...
    def edit():
        ...
        if Pessoa:
            ...
            Save_Change_btn = Button(EdFrame, text = 'Salvar', width = 30, command=save_change)
    ...
    Edit_btn = Button(EFrame, text='Editar', width=20, command=edit)
    Edit_btn.place(x=20, y=100)

    Retornar = Button(EFrame, text = 'Retornar', width = 20, command=lambda:back(EFrame))
    Retornar.place(x=210, y=100)


Edit_btn = ttk.Button(RFrame, text = 'Editar Informação', width = 40, command=editar)
Edit_btn.place(x=50, y=150)
...
def delete():
    ...
    Excluir_btn = Button(DFrame, text='Excluir', width=20, command=excluir)
    Excluir_btn.place(x=20, y=100)

    Retornar = Button(DFrame, text = 'Retornar', width = 20, command=lambda:back(DFrame))
    Retornar.place(x=210, y=100)


Del_btn = ttk.Button(RFrame, text = 'Excluir Informação', width = 40, command=delete)
...
def search():
    ...
    Procurar_btn = Button(SFrame, text='Procurar', width=20, command=procurar)
    Procurar_btn.place(x=20, y=100)

    Retornar = Button(SFrame, text = 'Retornar', width = 20, command=lambda:back(SFrame))
    Retornar.place(x=210, y=100)


Search_btn = ttk.Button(RFrame, text = 'Procurar Informação', width = 40, command=search)
Search_btn.place(x=50, y=350)


#BackButton
def back(frame):
    """Deleta o Frame retornando a tela inicial"""
    frame.destroy()
